...
(function() {
  var Docco, _, buildMatchers, commander, configure, defaults, document, format, fs, getLanguage, highlightjs, languages, marked, parse, path, projectName, run, version, write,
    slice = [].slice;
  ...
  format = function(source, sections, config) {
    ...
    for (i = j = 0, len = sections.length; j < len; i = ++j) {
      ...
      section.codeHtml = "<pre class=\"language-jsx\"><code>" + code + "</code></pre>";
